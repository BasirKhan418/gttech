                ...
                >
                  <Link href={`/industries/${category.slug}`}>
                    <div className="group relative transition-all duration-500 hover:scale-[1.02]">
                      <div className={`relative bg-white/85 backdrop-blur-sm border ${colorClasses.border} rounded-3xl overflow-hidden transition-all duration-500 hover:shadow-2xl hover:shadow-cyan-500/20 group-hover:bg-white/90`}>
              ...
              {featuredIndustries.map((industry, index) => (
                ...
                >
                  <Link href={`/industries/${industry.category}/${industry.slug}`}>
                    <div className="group relative bg-white/85 backdrop-blur-sm border border-cyan-300/50 rounded-3xl overflow-hidden hover:border-cyan-400/70 transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-cyan-500/15">
