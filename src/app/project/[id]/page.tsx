        ...
        return (
          <div className="space-y-8">
            ...
            {project.portfolios && project.portfolios.length > 0 && (
              <div className="bg-white/70 backdrop-blur-sm border border-blue-300/50 rounded-3xl p-8 shadow-xl">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  {project.portfolios.map((portfolio, index) => (
                    <div
                      key={index}
                      className="flex items-center gap-3 p-4 bg-blue-500/10 rounded-xl border border-blue-400/30"
                    >
                ...
                <div className="bg-white/70 backdrop-blur-sm border border-blue-300/50 rounded-3xl p-8 shadow-xl">
                  ...
                  <div className="space-y-3">
                    {project.industries.map((industry, index) => (
                      <div
                        key={index}
                        className="flex items-center gap-3 p-3 bg-blue-500/10 rounded-lg border border-blue-400/30"
                      >
              ...
              <div className="bg-white/70 backdrop-blur-sm border border-blue-300/50 rounded-3xl p-8 shadow-xl">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  {project.valuePropositions.map((value, index) => (
                    <div
                      key={index}
                      className="p-4 bg-gradient-to-r from-blue-500/10 to-blue-400/10 rounded-xl border border-blue-400/30"
                    >
        ...
        return (
          <div className="space-y-8">
            ...
            {project.pricingModel && (
              <div className="bg-white/70 backdrop-blur-sm border border-purple-300/50 rounded-3xl p-8 shadow-xl">
                <h3 className="text-2xl font-bold text-gray-800 mb-6 flex items-center">
                  <Package className="w-6 h-6 text-purple-600 mr-3" />
                  Pricing Model
                </h3>
                <div className="p-6 bg-gradient-to-r from-purple-500/10 to-purple-400/10 rounded-2xl border border-purple-400/30">
                  <p className="text-lg font-semibold text-purple-700">{project.pricingModel}</p>
                </div>
              </div>
            )}
                ...
                <div className="bg-white/70 backdrop-blur-sm border border-purple-300/50 rounded-3xl p-8 shadow-xl">
                  ...
                  <div className="space-y-3">
                    {project.integrations.map((integration, index) => (
                      <div
                        key={index}
                        className="flex items-center gap-3 p-3 bg-purple-500/10 rounded-lg border border-purple-400/30"
                      >
                  ...
                  <div className="flex items-center gap-3">
                    {project.apiSupport ? (
                      <>
                        ...
                        <span className="text-gray-700 font-medium">Full API Support Available</span>
                      </>
                    ) : (
                      <>
                        <div className="w-5 h-5 rounded-full border-2 border-gray-400"></div>
                        <span className="text-gray-700 font-medium">API Support Not Available</span>
                      </>
                    )}
                  </div>
                </div>
      ...
      case "electric vehicles":
        return (
          <div className="space-y-8">
            ...
            <div className="bg-white/70 backdrop-blur-sm border border-green-300/50 rounded-3xl p-8 shadow-xl">
              <h3 className="text-2xl font-bold text-gray-800 mb-6 flex items-center">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                {project.batteryCapacity && (
                  <div className="p-4 bg-green-500/10 rounded-xl border border-green-400/30 text-center">
                    ...
                    <p className="text-sm text-gray-600 mb-1">Battery Capacity</p>
                    <p className="font-bold text-green-700">{project.batteryCapacity}</p>
                  </div>
                )}
                {project.range && (
                  <div className="p-4 bg-green-500/10 rounded-xl border border-green-400/30 text-center">
                    ...
                    <p className="font-bold text-green-700">{project.range}</p>
                  </div>
                )}
                {project.chargingTime && (
                  <div className="p-4 bg-green-500/10 rounded-xl border border-green-400/30 text-center">
                    <Clock className="w-8 h-8 text-green-600 mx-auto mb-2" />
                    <p className="text-sm text-gray-600 mb-1">Charging Time</p>
                    <p className="font-bold text-green-700">{project.chargingTime}</p>
                  </div>
                )}
                {project.motorType && (
                  <div className="p-4 bg-green-500/10 rounded-xl border border-green-400/30 text-center">
                    <Settings className="w-8 h-8 text-green-600 mx-auto mb-2" />
                    <p className="text-sm text-gray-600 mb-1">Motor Type</p>
                    <p className="font-bold text-green-700">{project.motorType}</p>
                  </div>
                )}
              </div>
            </div>
      ...
      case "furnitures":
        return (
          <div className="space-y-8">
            ...
            <div className="bg-white/70 backdrop-blur-sm border border-orange-300/50 rounded-3xl p-8 shadow-xl">
              <h3 className="text-2xl font-bold text-gray-800 mb-6 flex items-center">
                <Sofa className="w-6 h-6 text-orange-600 mr-3" />
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {project.dimensions && (
                  <div className="p-4 bg-orange-500/10 rounded-xl border border-orange-400/30">
                    ...
                    <p className="text-gray-700">{project.dimensions}</p>
                  </div>
                )}
                {project.weight && (
                  <div className="p-4 bg-orange-500/10 rounded-xl border border-orange-400/30">
                    ...
                    <p className="text-gray-700">{project.weight}</p>
                  </div>
                )}
              </div>
            </div>
                ...
                <div className="bg-white/70 backdrop-blur-sm border border-orange-300/50 rounded-3xl p-8 shadow-xl">
                  ...
                  <div className="space-y-3">
                    {project.material.map((mat, index) => (
                      <div
                        key={index}
                        className="flex items-center gap-3 p-3 bg-orange-500/10 rounded-lg border border-orange-400/30"
                      >
                  ...
                  <div className="flex items-center gap-3">
                    {project.assemblyRequired ? (
                      <>
                        ...
                        <span className="text-gray-700 font-medium">Assembly Required</span>
                      </>
                    ) : (
                      <>
                        <CheckCircle className="w-5 h-5 text-green-600" />
                        <span className="text-gray-700 font-medium">Pre-assembled</span>
                      </>
                    )}
                  </div>
                </div>
          ...
          <div className="space-y-8">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {project.sizes && project.sizes.length > 0 && (
                <div className="bg-white/70 backdrop-blur-sm border border-pink-300/50 rounded-3xl p-8 shadow-xl">
                  <h3 className="text-xl font-bold text-gray-800 mb-6 flex items-center">
                    <Ruler className="w-5 h-5 text-pink-600 mr-3" />
                    Available Sizes
                  </h3>
                  <div className="flex flex-wrap gap-3">
                    {project.sizes.map((size, index) => (
                      <div
                        key={index}
                        className="px-4 py-2 bg-pink-500/10 rounded-lg border border-pink-400/30 text-center"
                      >
                        <span className="font-semibold text-pink-700">{size}</span>
                      </div>
                    ))}
                  </div>
                </div>
                  ...
                  <div className="flex flex-wrap gap-3">
                    {project.colors.map((color, index) => (
                      <div
                        ...
                        className="px-4 py-2 bg-pink-500/10 rounded-lg border border-pink-400/30 text-center"
                      >
                        <span className="font-semibold text-pink-700">{color}</span>
                      </div>
                    ))}
                  </div>
                </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {project.fabric && project.fabric.length > 0 && (
                <div className="bg-white/70 backdrop-blur-sm border border-pink-300/50 rounded-3xl p-8 shadow-xl">
                  <h3 className="text-xl font-bold text-gray-800 mb-6 flex items-center">
                    <ShirtIcon className="w-5 h-5 text-pink-600 mr-3" />
                    Fabric Composition
                  </h3>
                  <div className="space-y-3">
                    {project.fabric.map((fab, index) => (
                      <div
                        key={index}
                        className="flex items-center gap-3 p-3 bg-pink-500/10 rounded-lg border border-pink-400/30"
                      >
              ...
              {project.careInstructions && project.careInstructions.length > 0 && (
                <div className="bg-white/70 backdrop-blur-sm border border-pink-300/50 rounded-3xl p-8 shadow-xl">
                  <h3 className="text-xl font-bold text-gray-800 mb-6 flex items-center">
                    <Scissors className="w-5 h-5 text-pink-600 mr-3" />
                    Care Instructions
                  </h3>
                  <div className="space-y-3">
                    {project.careInstructions.map((instruction, index) => (
                      <div
                        key={index}
                        className="flex items-start gap-3 p-3 bg-pink-500/10 rounded-lg border border-pink-400/30"
                      >
      ...
      <div className="relative z-10 pt-16 sm:pt-20 lg:pt-24 pb-4 sm:pb-6 lg:pb-8 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-4 mb-4 sm:mb-6">
            <Link
              href="/project"
              className="inline-flex items-center text-cyan-600 hover:text-cyan-700 transition-colors duration-300 text-sm sm:text-base"
            >
              ...
              <div className="relative bg-white/70 backdrop-blur-sm border border-cyan-600/50 rounded-2xl sm:rounded-3xl p-4 sm:p-6 lg:p-8 shadow-xl">
                ...
                <div className="relative z-10">
                  ...
                  <div className="prose prose-gray max-w-none">
                    <p className="text-gray-700 leading-relaxed text-base sm:text-lg">{projectDetail.description}</p>
                  </div>
                </div>
              </div>
                ...
                <div className="relative z-10">
                  ...
                  <div className="space-y-2 sm:space-y-3 text-xs sm:text-sm">
                    <div className="flex justify-between items-start">
                      ...
                      <span className="text-cyan-700 font-semibold text-right">{categoryConfig.name}</span>
                    </div>
                    <div className="flex justify-between items-start">
                    ...
                    <div className="flex justify-between items-start">
                      ...
                      <span className="text-cyan-700 font-semibold text-right">
          ...
          <div className="relative bg-white/70 backdrop-blur-sm border border-cyan-600/50 rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-12 overflow-hidden shadow-2xl">
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center max-w-md sm:max-w-none mx-auto">
                ...
                >
                  Explore More {categoryConfig.name}
                </Link>
              </div>
            </div>
