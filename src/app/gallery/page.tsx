        ...
        <div className="max-w-7xl mx-auto">
          <div className="animate-on-scroll opacity-0 translate-y-10">
            <div className="flex justify-center mb-8">
              <div className="bg-gray-900/40 backdrop-blur-sm border border-sky-500/20 rounded-2xl p-2 flex space-x-2">
                <button
          ...
          {activeTab === 'image' ? (
            ...
            <div>
              {imageAlbums.length === 0 ? (
                <div className="text-center py-20">
                  <div className="animate-on-scroll opacity-0 translate-y-10">
                    <ImageIcon className="w-16 h-16 text-sky-400 mx-auto mb-6" />
                    <h3 className="text-2xl font-bold text-white mb-4">No Albums Yet</h3>
                    <p className="text-gray-400">Image albums will appear here once they're added.</p>
                  </div>
                </div>
              ) : (
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                  {imageAlbums.map((album, index) => (
                    ...
                    >
                      <div 
                        className="group relative bg-gray-900/40 backdrop-blur-sm border border-sky-500/20 rounded-3xl overflow-hidden hover:border-sky-400/40 transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-sky-500/10 cursor-pointer"
                      ...
                      >
                        ...
                        <div className="relative z-10 p-6">
                          ...
                          <h3 className="text-xl font-bold text-white mb-3 group-hover:text-sky-200 transition-colors duration-300">
                            {album.title}
                          </h3>
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <ChevronRight className="w-4 h-4 text-sky-400 group-hover:translate-x-1 group-hover:text-sky-300 transition-all duration-300" />
                          </div>
                        </div>
                      </div>
                    </div>
            ...
            <div>
              {videoItems.length === 0 ? (
                <div className="text-center py-20">
                  <div className="animate-on-scroll opacity-0 translate-y-10">
                    <Video className="w-16 h-16 text-sky-400 mx-auto mb-6" />
                    <h3 className="text-2xl font-bold text-white mb-4">No Videos Yet</h3>
                    <p className="text-gray-400">Videos will appear here once they're added.</p>
                  </div>
                </div>
              ) : (
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                  {videoItems.map((video, index) => (
                    ...
                    >
                      <div className="group relative bg-gray-900/40 backdrop-blur-sm border border-sky-500/20 rounded-3xl overflow-hidden hover:border-sky-400/40 transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-sky-500/10">
                        ...
                        <div className="relative z-10 p-6">
                          <div className="flex items-center justify-between mb-3">
                            <span className="px-3 py-1 bg-red-500/20 text-red-300 text-xs font-medium rounded-full border border-red-400/30">
                              Video
                            </span>
                            <span className="text-gray-500 text-xs flex items-center">
                              <Calendar className="w-3 h-3 mr-1" />
                          ...
                          <a
                            ...
                            className="inline-flex items-center space-x-2 text-sky-400 font-semibold text-sm group-hover:text-sky-300 transition-colors duration-300"
                          >
